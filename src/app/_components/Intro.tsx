  ...
  return (
    <section className="flex flex-col lg:flex-row justify-center items-center py-20">
      ...
      <div className="flex-1 flex flex-col justify-center items-center md:min-w-[400px]">
        <h1 className="text-main font-main text-[1.6rem] sm:text-[1.8rem] lg:text-[2rem] xl:text-[2.2rem] font-[600] lg:mb-2">
          허태웅 기술 블로그
        </h1>
        <p className="text-main font-main sm:text-[1rem] font-[500]">
          배우고 고민한 흔적들을 공유합니다
        </p>
        <p className="text-main font-main sm:text-[1rem] font-[500]">
