...
추가적으로 `onRefresh` 함수의 하드코딩된 메시지들, **_Alert_** 함수도 `errorAlert` 라는 유틸함수로 템플릿화 하였습니다. 함수의 인자들이 무엇을 의미하는지 명확히 파악하기 위해 파라미터를 객체로 만들었죠.
...
훅의 의도를 유지하고, 동시에 인터벌의 존재를 확실히 파악시켜 잠재적인 오류를 제거시켰습니다.
