...
```js
const myPromiseincreaseAndPrintincreaseAndPrintiincreaseAndPrintncreaseAndPrint =
  new Promise((resolve, rejecthaissdsdqwerqweqwerqrqwerqwre) => {
    haissdsdqwerqweqwerqrqwerqwre;
    // 구현..
  });
```
